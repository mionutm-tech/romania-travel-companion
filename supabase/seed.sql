...
-- ============================================
-- Planner attribute backfill (Stage 2)
-- Sets realistic duration / price / accessibility / featured / time fields
-- on each of the 23 seeded POIs. Idempotent.
-- ============================================
UPDATE pois SET
  duration_minutes = CASE id
    -- Bucharest
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN 120 -- Palace of Parliament
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN 75  -- Athenaeum
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN 90  -- Caru' cu Bere
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN 120 -- Herăstrău Park
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN 120 -- Nat. Museum of Art
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN 30  -- Stavropoleos
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN 180 -- Control Club
    -- Brașov
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN 120 -- Bran Castle
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN 60  -- Black Church
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN 90  -- Tâmpa cable car
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN 60  -- Council Square
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN 75  -- Sergiana
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN 240 -- Poiana Brașov
    -- Sibiu
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN 120 -- Brukenthal
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN 180 -- ASTRA
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN 45  -- Grand Square
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN 20  -- Bridge of Lies
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN 90  -- Saxon wine cellar
    -- Cluj
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN 45  -- St Michael's
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN 120 -- Botanical Garden
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN 60  -- Central Park
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN 90  -- Roata
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN 150 -- Flying Circus
    ELSE duration_minutes
  END,
  price_level = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN 1
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN 0
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN 2
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN 2
    ELSE price_level
  END,
  family_friendly = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN false -- nightclub
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN false -- nightclub
    ELSE true
  END,
  indoor = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN true
    ELSE indoor
  END,
  accessible = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN false
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN true
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN false
    ELSE accessible
  END,
  featured_score = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN 95
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN 85
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN 80
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN 60
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN 70
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN 75
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN 50
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN 95
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN 80
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN 70
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN 75
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN 60
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN 65
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN 85
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN 80
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN 70
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN 60
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN 55
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN 70
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN 65
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN 50
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN 60
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN 55
    ELSE featured_score
  END,
  best_time_of_day = CASE id
    WHEN 'aa000000-0000-0000-0000-000000000001' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000002' THEN 'evening'
    WHEN 'aa000000-0000-0000-0000-000000000003' THEN 'midday'
    WHEN 'aa000000-0000-0000-0000-000000000004' THEN 'afternoon'
    WHEN 'aa000000-0000-0000-0000-000000000005' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000006' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000007' THEN 'night'
    WHEN 'aa000000-0000-0000-0000-000000000008' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000009' THEN 'midday'
    WHEN 'aa000000-0000-0000-0000-000000000010' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000011' THEN 'any'
    WHEN 'aa000000-0000-0000-0000-000000000012' THEN 'midday'
    WHEN 'aa000000-0000-0000-0000-000000000013' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000014' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000015' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000016' THEN 'any'
    WHEN 'aa000000-0000-0000-0000-000000000017' THEN 'any'
    WHEN 'aa000000-0000-0000-0000-000000000018' THEN 'evening'
    WHEN 'aa000000-0000-0000-0000-000000000019' THEN 'midday'
    WHEN 'aa000000-0000-0000-0000-000000000020' THEN 'morning'
    WHEN 'aa000000-0000-0000-0000-000000000021' THEN 'afternoon'
    WHEN 'aa000000-0000-0000-0000-000000000022' THEN 'evening'
    WHEN 'aa000000-0000-0000-0000-000000000023' THEN 'night'
    ELSE best_time_of_day
  END,
